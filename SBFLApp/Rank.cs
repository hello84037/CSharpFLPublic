...
namespace SBFLApp
{
    public class Rank
    {
        ...
        public void WriteSuspiciousnessReport(string filePath, SuspiciousnessReportSnapshot snapshot, SuspiciousnessReportFormat format)
        {
            ...
            {
                System.Console.WriteLine($"The file {filePath} is currently open.  Please close it and then press any key");
            ...
            {
                System.Console.WriteLine($"The file {filePath} is still open.  Unable to write the report.");
            }
        }
